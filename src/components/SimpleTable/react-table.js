...
class ReactTable extends React.Component {
  ...
  generateColumn(col) {
    ...
    return (
      <th key={col.name} onClick={this.sortColumn.bind(this, col)}>
        {col.name}
      </th>
    );
  }
      ...
      <div className="rt-pagination">
        {this.state.currentPage != 1 ? (
          <div className="previous-page">
            <a onClick={this.showPrevious.bind(this)}>Previous</a>
          </div>
        ) : (
          ''
        )}
        <div className="next-page">
          <a onClick={this.showNext.bind(this)}>Next</a>
        </div>
      </div>
    );
  }
